    ...
    <section className="py-16 px-4 md:px-8 lg:px-16 min-h-screen relative overflow-hidden">
      ...
      {mensajeEstado.show && (
        <div className="fixed top-4 right-4 z-50 animate-fade-in">
          <div className={`px-6 py-4 rounded-lg shadow-lg flex items-center ${mensajeEstado.type === 'success' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
            <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 mr-3 ${mensajeEstado.type === 'success' ? 'text-green-500' : 'text-red-500'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <span className="font-medium">{mensajeEstado.message}</span>
          </div>
        </div>
      )}
      ...
      <div className="relative z-10 container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <h3 className="text-2xl font-bold text-primary-dark mb-6 font-cinzel">Envíanos un mensaje</h3>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary-accent" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div>
            <h3 
              className="text-2xl font-bold text-primary-dark mb-6 font-cinzel"
              style={{ 
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-12 w-12 rounded-md bg-primary-accent/20 text-primary-brown">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-primary-dark">Dirección</h4>
                    <p className="mt-1 text-gray-600">Anexo Andrés Avelino Cáceres 1, Piura 20001</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-primary-dark">Teléfono</h4>
                    <p className="mt-1 text-gray-600">+51 978 704 402</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-primary-dark">Correo electrónico</h4>
                    <p className="mt-1 text-gray-600">johandiosesrazuri@hgmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-primary-dark">Horario de atención</h4>
                    <p className="mt-1 text-gray-600">Lunes a Viernes: 9:00 AM - 8:00 PM</p>
                    <p className="text-gray-600">Sábados y Domingos: 10:00 AM - 10:00 PM</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              <h4 className="text-lg font-medium text-primary-dark mb-4">Síguenos en redes sociales</h4>
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/UTP.Peru/?locale=es_LA" className="text-primary-brown hover:text-primary-accent transition-colors duration-300">
                  <span className="sr-only">Facebook</span>
                  <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                  </svg>
                </a>
                <a href="https://www.instagram.com/universidadutp?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="text-primary-brown hover:text-primary-accent transition-colors duration-300">
                ...
                <a href="https://www.tiktok.com/@universidadutp" className="text-primary-brown hover:text-primary-accent transition-colors duration-300">
