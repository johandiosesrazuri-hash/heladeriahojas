          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-[#d7ccc8] font-quicksand">Anexo Andrés Avelino Cáceres 1, Piura 20001</span>
              </li>
              <li className="flex items-center">
                ...
                <span className="text-[#d7ccc8] font-quicksand">+51 978 704 402</span>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#dbbba6] mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-[#d7ccc8] font-quicksand">johandiosesrazuri@hgmail.com</span>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#dbbba6] mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
