...
const Footer = () => {
  return (
    <footer className="bg-[#3e2723] text-[#f5f0e8] pt-16 pb-8 px-4 md:px-8 lg:px-16">
      <div className="container-custom mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[#d7ccc8] mb-6 font-quicksand">
          ...
          <div>
            <h3 className="text-xl font-bold mb-6 font-cinzel text-[#dbbba6]">Enlaces Rápidos</h3>
          ...
          {/* Columna 3: Contacto */}
          <div>
            <h3 className="text-xl font-bold mb-6 font-cinzel text-[#dbbba6]">Contacto</h3>
            <ul className="space-y-4">
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#dbbba6] mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span className="text-[#d7ccc8] font-quicksand">Av. Los Sabores 123, Lima - Perú</span>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#dbbba6] mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-[#d7ccc8] font-quicksand">(01) 234 5678</span>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#dbbba6] mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-[#d7ccc8] font-quicksand">info@choccodelight.com</span>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#dbbba6] mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-[#d7ccc8] font-quicksand">
                  Lun-Sáb: 10:00 AM - 10:00 PM<br />
                  Dom: 11:00 AM - 8:00 PM
                </span>
              </li>
            </ul>
          </div>
          ...
          <div>
            <h3 className="text-xl font-bold mb-6 font-cinzel text-[#dbbba6]">Newsletter</h3>
            <p className="text-[#d7ccc8] mb-4 font-quicksand">
            ...
            <p className="text-xs text-[#a1887f] font-quicksand">
        ...
        {/* Separador */}
        <div className="border-t border-[#5d4037] my-8"></div>

        {/* Copyright */}
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-[#d7ccc8] text-sm mb-4 md:mb-0 font-quicksand">
            © 2025 Heladería ChoccoDelight. Todos los derechos reservados.
          </p>
          <div className="flex space-x-6">
            <a href="#" className="text-[#d7ccc8] hover:text-[#dbbba6] text-sm transition-colors duration-300 font-quicksand">
